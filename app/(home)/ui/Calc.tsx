...
const rangeArray =[{max: 100, min: 0, marks:{ 0: 'Метраж', 28: '28 кв.м.', 100: '100 кв.м.'}}, {max: 1000, min: 0, marks:{ 0: 'граммовка', 400: '400 грамм', 1000: '1000 грамм',}}, {max: 100, min: 0, marks:{0: 'Свыше 2,5 метров', 100: '100 метров',}}];
const funcArray = [
        function(range: any) {
          if(range < 28) {
